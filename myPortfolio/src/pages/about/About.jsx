      ...
      <div className="about-container">
        <div>
          ...
          <p className="about-paragraph">
            Hey there! I'm Nobz, a fashion lover turned software developer, with
            a passion for both stitching fabrics and stitching code. My journey
            into the tech world started when I watched a friend transform lines
            of code into a living, breathing application—it felt like magic! I
            couldn’t resist, so I asked if I could learn too, and before I knew
            it, I was knee-deep in Angela Yu's Udemy course, fully hooked.
          </p>
          <p className="about-paragraph">
          ...
          <p className="about-paragraph">
            ...
            by piece. Just like tailoring fabric into a perfectly fitted outfit,
            watching code come alive in the browser feels like seeing someone
            wear a custom-made piece of clothing. And when it all fits together
