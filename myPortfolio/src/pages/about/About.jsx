  ...
  return (
    <div className="about-container">
      ...
      <p className="about-paragraph">
        ...
        friend code, and it felt like witnessing a spellbinding magic trick. The
        way lines of code could evolve into fully functional applications left
        me mesmerized. Driven by this newfound excitement, I aasked if I could
        also learn it and I was given a course of Udemy(Angela Yu's course) I
        delved into coding myself. I would not say it has been easy, in
        hinsight, its been tough for me because at some point, I had school, at
        another work. I am not where I want to be yet but creating this
        portfolio is a step in the right direction.
      </p>
      ...
      <p className="about-paragraph">
        ...
        both innovative and effective. I am currently on the journey to perfect
        Javascript and React. I thrive on the challenge of solving complex
        problems and turning creative ideas into functional software.
      </p>
      ...
      <p className="about-paragraph">
        ...
        on exciting projects. Feel free to reach out through email, LinkedIn or
        twitter. Let’s build something amazing together!
      </p>
    </div>
  );
}
